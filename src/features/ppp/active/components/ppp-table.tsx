...
export function PppTable({ data, search, navigate }: PppTableProps) {
  ...
  const renderMobileCard = (row: Row<PppoeActive>, index: number) => {
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                  ...
                  {item.uptime && (
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-xs font-mono">{formatUptime(item.uptime)}</span>
                    </div>
                  )}
                  ...
                  {item.encoding && (
                    <div className="flex items-center space-x-2">
                      <Network className="h-4 w-4 text-orange-600 flex-shrink-0" />
                      <span className="font-medium">Encoding:</span>
                      <span className="text-xs">{item.encoding}</span>
                    </div>
                  )}
