...
const FormSchema = z.object({
  ...
  // Additional profile-specific fields for details tab
...
export function EditProfileModal({ open, onOpenChange, profileData }: EditProfileModalProps) {
  ...
  useEffect(() => {
    if (profileData && open) {
      form.reset({
        ...
        expiredMode: profileData.expiredMode || "none",
        price: profileData.price || "",
        sellingPrice: profileData.sellingPrice || "",
        lockUser: profileData.lockUser || "disable",
        lockServer: profileData.lockServer || "disable",
        bandwidth: profileData.bandwidth || "",
        sessionTimeout: profileData.sessionTimeout || "",
        idleTimeout: profileData.idleTimeout || "",
        downloadLimit: profileData.downloadLimit || "",
        uploadLimit: profileData.uploadLimit || "",
        maxSessions: profileData.maxSessions || "",
