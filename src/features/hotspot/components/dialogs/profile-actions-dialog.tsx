...
const FormSchema = z.object({
  name: z.string().min(1, 'Profile name is required.').transform((name) => name.trim()),
...
export function ProfileActionsDialog({ currentRow, open, onOpenChange }: ProfileActionDialogProps) {
