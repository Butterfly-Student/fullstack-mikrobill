  ...
  const handleDelete = () => {
    ...
    toast.promise(sleep(2000), {
      ...
      success: () => {
        ...
        return `Deleted ${selectedRows.length} ${selectedRows.length > 1 ? 'permissions' : 'permission'
          }`
      },
      error: 'Error',
    })
    ...
    <ConfirmDialog
      ...
      title={
        <span className='text-destructive'>
          ...
          {selectedRows.length > 1 ? 'permissions' : 'permission'}
        </span>
      }
      desc={
        <div className='space-y-4'>
          <p className='mb-2'>
            Are you sure you want to delete the selected permissions? <br />
            This action cannot be undone and may affect user access rights.
          </p>
